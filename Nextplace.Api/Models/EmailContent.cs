...
{
  private static readonly string EmailTemplate = @"<!doctype html>
...
<body style=""background: white;"">
											...
											<td style=""word-wrap:break-word;font-size:0px;padding:0px 0px 0px 0px;padding-top:0px;padding-bottom:10px;padding-right:25px;padding-left:25px;"" align=""left"">
												<div style=""cursor:auto;color:#5E6977;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;"">
													<style></style><p style=""margin: 10px 0;""><span style=""font-family:Times New Roman;""><span style=""color:black;""><span style=""font-size:15px;"">
                                                         <p style=""font-family:Montserrat, sans-serif;font-weight:400;color:black;font-size:16.8px;margin-top:30px"">[Body]</p>  
													<br />
													<br />
  ...
  private static string GetEmailContent(string title, string body) => EmailTemplate
    .Replace("[Title]", title)
    .Replace("[Body]", body);
  ...
  internal static string NewUserEmailValidation(string newUserValidationPage, string validationKey, string emailAddress)
  {
    ...
    var body =
      $@"Dear <b>{emailAddress}</b>,
<br/><br/>
Thank you for signing up for Nextplace! We are thrilled to have you on board.
<br/><br/>
To complete your registration, please confirm that your email address is valid by clicking the link below:
<br/><br/>
<a href=""{string.Format(newUserValidationPage, validationKey, emailAddress)}"">Click here to confirm your email address</a>. This link will be valid for 20 minutes.
<br/><br/>
If you did not sign up for Nextplace, please ignore this email.
<br/><br/>
We look forward to providing you with the best experience possible.";

    return GetEmailContent(title, body);

  }

  internal static string ForgotPasswordEmailValidation(string forgotPasswordValidationPage, string validationKey, string emailAddress)
  {
    var title = "Reset your Nextplace password";

    var body =
      $@"Dear <b>{emailAddress}</b>,
<br/><br/>
We received a request to reset the password for your Nextplace account. If you made this request, please click the link below to reset your password:
<br/><br/>
<a href=""{string.Format(forgotPasswordValidationPage, validationKey, emailAddress)}"">Click here to reset your password</a>. This link will be valid for 20 minutes.
<br/><br/>
